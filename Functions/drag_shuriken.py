...
def drag_shuriken(Rocket, theta, alpha, Uinf, nu):
    #trad to python from matlab at 10/10/19 to test
...
# =========================== Compute values ==============================
    ...
    return Rocket.ab_n*CD0*qr*S/Rocket.Sm;
...
# ==================== Parameters measured with CATIA =====================
    ...
    surface_tab = np.asarray([0, 1.1, 2.23, 3.38, 4.56, 5.76, 6.98, 8.22, 9.48, 10.75, 12.03, 13.32, 14.61, 15.9, 17.19])*10**-4; 
    
    # height in m
    h_tab = np.asarray([0, 3.76, 7.45, 11.04, 14.5, 17.81, 20.95, 23.88, 26.58, 29.03, 31.2, 33.09, 34.64, 35.87, 36.76])*10**-3; 
...
# ===================== Interpolation and conversions =====================
    ...
    #TODO : was like this in matlab, not sure this is the right interpolation translation.
    ...
    # interpolated surface in function of angle 
    f = interpolate.interp1d(angle_tab, surface_tab)(angle)
    
    # interpolated height distance from rocket body
    h = interpolate.interp1d(angle_tab, h_tab)(angle)
    return [f,h]
