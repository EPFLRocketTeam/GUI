...
# Compute mass, mass derivative, center of mass position from cone tip, 
# Inertia moment tensor and derivative of the inertia moment tensor. 

def RocketInertia(t, Rocket, massmodel):
# INPUTS : 
# - t           :   time [s]
...
# - dIdt        :   Time derivative of moment of inertia tensor in rocket coordinate system (3x3)[kgm^2/s]
    ...
    import numpy as np
    from '*****' import Mass_Lin,Mass_Non_Lin
    ...
    I_L = Rocket.rocket_I + I_L_Casing + I_L_Grain + (Grain_Mass+Rocket.casing_mass)*(Rocket.L-CM-Rocket.motor_length/2) # I + ... + Steiner
    # rotational inertia
